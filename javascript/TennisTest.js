...
var checkScoreOpt = function(reporter, TennisGame, player1Score, player2Score, expectedScore) {
    var highestScore = Math.max(player1Score, player2Score);
    var game;
    var result;
    var message = "";
...
var runSuiteOnGame = function(reporter, TennisGame, title) {
    ...
    if (TennisGame === typeof(TennisGame1)) {
        allScores.forEach(function(score) {
            checkScoreOpt(reporter, TennisGame, score[0], score[1], score[2]);
        });
    } else {
        allScores.forEach(function(score) {
